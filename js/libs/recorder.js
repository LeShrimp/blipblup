...
(function() {
  define([], function() {
    var BUFFER_LEN, NUM_CHANNELS, Recorder, audioCtx, flatten, getBuffers, initNewRecording, initRecorderAudioGraph, input, isRecording, isRecordingPossible, processorNode, recBuffers, recLength;
    BUFFER_LEN = 4096;
    NUM_CHANNELS = 2;
    isRecording = false;
